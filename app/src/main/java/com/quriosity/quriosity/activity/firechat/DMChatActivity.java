...
import com.quriosity.quriosity.adapter.firechat.SingleChatAdapter;
...
import static com.quriosity.quriosity.utils.FirebaseUtil.FIRSTNAME_FIRE;
...
public class DMChatActivity extends AppCompatActivity {
    ...
    private SingleChatAdapter testAdapter;
    private String actor2ImgUrl = "";
    private String isItNewChat = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myID = intent.getExtras().getString(EXTRAS_MEACTOR1);
        actor2ID = intent.getExtras().getString(EXTRAS_ACTOR2);
        if (intent.getExtras().getString(Intent.EXTRA_REFERRER_NAME) != null) {
            isItNewChat = intent.getExtras().getString(Intent.EXTRA_REFERRER_NAME);
        }
        actor2ImgUrl = MyUtil.FIREBASE_STORAGE_BASE_URL + "users%2F" + actor2ID + "%2F" + "iconimg" + MyUtil.FIREBASE_STORAGE_END_URL;
        mdatabase = FirebaseFirestore.getInstance();
        Log.d(TAG, "onCreate: conversationID " + conversationID);
        Log.d(TAG, "onCreate: myID " + myID);
        Log.d(TAG, "onCreate: actor2ID " + actor2ID);
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DMChatActivity.this, "This feature will be added soon", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        send_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (input_user_message.getText().toString().isEmpty() && input_user_message.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(DMChatActivity.this, "Please enter message to send", Toast.LENGTH_SHORT).show();
                    return;
                }
                sendMessage();
            }
        ...
        send_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePickerActivity.clearCache(DMChatActivity.this);
        ...
        if (!isItNewChat.equalsIgnoreCase(EXTRAS_CONTACTS_FRAG)) {
            setupRecyclerScroll();
        }
        setupRichContentEditText();

        Glide.with(DMChatActivity.this).load(actor2ImgUrl)
                .error(Glide.with(DMChatActivity.this)
        ...
        findViewById(R.id.conversation_contact_photo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new StfalconImageViewer.Builder<String>(DMChatActivity.this, new ArrayList<>(Arrays.asList(actor2ImgUrl)), new ImageLoader<String>() {
                    @Override
                    public void loadImage(ImageView imageView, String image) {
                        Glide.with(DMChatActivity.this).load(image).into(imageView);
                    }
                }).show();
            }
        });
    ...
    public void onBackPressed() {
        ...
        if (isItNewChat.equalsIgnoreCase(EXTRAS_FCM_SERVICES)) {
            //TODO open chat Dashboard
        }
    }

    private void setupLisnterForNameAndIcon() {
        mdatabase.collection(USERS_FIRESTORE)
                .document(actor2ID)
                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    @Override
                    public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                        chatUserName.setText(value.get(FIRSTNAME_FIRE).toString());
                                ...
                                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                    ...
                                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                                        ...
                                        if (getReadArray != null) {
                                            if (getReadArray.contains(actor2ID)) {
                                                chatUserActiveStatus.setText("Typing...");
                                            } else {
                                                if (value.get("onlineStatus").toString().equalsIgnoreCase(EXTRAS_ONLINE_STS0)) {
                                                    chatUserActiveStatus.setText(MyUtil.lastSeenConverter(value.get(EXTRAS_ONLINE_TIMESTAMP).toString()));
                                                } else
                                                    chatUserActiveStatus.setText(MyUtil.firstLetterCap(value.get(EXTRAS_USER_ONLINE_STATUS).toString()));
                                            }
                                        }
                                    }
                                });
...
//                        Toast.makeText(DMChatActivity.this,
...
//                        Log.d(TAG, "onRichContent: GIf URL: file://" + richContentFile.getAbsolutePath());
//                        Log.d(TAG, "onRichContent: Real GIf URL: " + contentUri);
//                    }
...
//                        EXTRAS_ONLINE_STS1);
    ...
    private void setUpRecyclerChatsList() {
        ...
        query.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                testAdapter = new SingleChatAdapter(DMChatActivity.this, messageModel, conversationID, myID, actor2ID);
                layoutManager = new LinearLayoutManager(DMChatActivity.this, RecyclerView.VERTICAL, true);
        ...
        query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                if (queryDocumentSnapshots.size() > 0) {
                    ...
                    Toast.makeText(DMChatActivity.this, "All Messages Loaded", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void sendMessage() {
        ...
        firestoreDMTextEntry(conversationID, input_user_message.getText().toString().trim(), "text",
                myID, MyUtil.getTimeStampInMillis(), actor2ID, "", sentarr, readarr, deletearr, receivedarr);
    ...
    private void sendMEMESMessage(Uri contentUri) {
        ...
        firestoreDMMIMEEntry(conversationID, "", "image",
                myID, MyUtil.getTimeStampInMillis(), actor2ID,
                "https://i.pinimg.com/originals/a4/f2/cb/a4f2cb80ff2ae2772e80bf30e9d78d4c.gif",
                sentarr, readarr, deletearr, contentUri, receivedarr);
        input_user_message.setText("");
        input_user_message.requestFocus();
    }
